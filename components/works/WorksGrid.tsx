...
const COLUMNS = [
  ...
  { data: '출고예정일', title: '출고예정일', readOnly: false, width: 110, fieldType: 'date' as FieldType, type: 'date', dateFormat: 'YYYY-MM-DD', correctFormat: true, editor: 'date' },
  ...
  { data: '디자이너_노트', title: '디자이너 노트', readOnly: false, width: 200, fieldType: 'text' as FieldType },
