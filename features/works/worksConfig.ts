...
export const COLUMNS = [
  ...
  { data: 'metal_purity',  title: '함량비',  readOnly: true,  width: 70,  fieldType: 'lookup'   as FieldType, outputType: 'number' as FieldType },
  ...
  { data: '시세_g당',      title: '시세(g당)', readOnly: true, width: 100, fieldType: 'lookup'  as FieldType, outputType: 'number' as FieldType },
  ...
  // 수량: GENERATED ALWAYS (발주_수량 + 수량_조정) — DB 계산 컬럼 → formula
  { data: '수량',          title: '수량',    readOnly: true,  width: 70,  fieldType: 'formula'  as FieldType, outputType: 'number' as FieldType },
  ...
  { data: '기준_중량',     title: '기준 중량', readOnly: true, width: 100, fieldType: 'lookup'  as FieldType, outputType: 'number' as FieldType },
  ...
  { data: '기본_공임',     title: '기본 공임', readOnly: true, width: 80, fieldType: 'lookup'  as FieldType, outputType: 'number' as FieldType },
  ...
  { data: '가다번호_목록', title: '가다번호',  readOnly: true, width: 100, fieldType: 'lookup'  as FieldType },
  { data: '가다_위치_목록', title: '가다 위치', readOnly: true, width: 100, fieldType: 'lookup'  as FieldType },
  ...
  // 순금_중량: 중량 × 함량비 비율로 산출 (DB 트리거 sync) — formula
  { data: '순금_중량',     title: '순금 중량', readOnly: true, width: 100, fieldType: 'formula' as FieldType, outputType: 'number' as FieldType },
  ...
  { data: 'created_at',    title: 'created at', readOnly: true, width: 160, fieldType: 'date'   as FieldType, system: true },
...
function transformWorksRow(item: Item, ctx: { holidays: Set<string> }): Row {
  ...
  return {
    ...
    번들_명칭: item.번들_명칭 ?? '',
    metal_price_표시: item.metal_price_표시 ?? '',
    매입_표시: item.매입_표시 ?? '',
    원부자재: '',
    발주_현황: '',
    작업_위치: item.작업_위치 ?? '',
